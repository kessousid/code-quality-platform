import type { ScanJobData } from '@cqp/core';
 ...
 * API's auth guard, so nothing else establishes it.
 */
export async function processRunScanJob(prisma: PrismaClient, data: ScanJobData): Promise<void> {
